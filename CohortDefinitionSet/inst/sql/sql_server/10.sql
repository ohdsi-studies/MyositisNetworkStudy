...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3013023,3018576,40759850,3015302,3036086,3046519,42529529,3052971,3046209,42870556,3048888,42529588,42529265,3030635,40759863,42529058,3030939,40759864,42528593,36031500,36305608,42529123,3013637,40759862,40759756,36304323,42529125,36303431,42529124,42529582,36306115,42528691,3015302,3018576,40759850,3036086,42529584,42529583,42528690,42529598,42529597,42528689,3966634)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3013023,3018576,40759850,3015302,3036086,3046519,42529529,3052971,3046209,42870556,3048888,42529588,42529265,3030635,40759863,42529058,3030939,40759864,42528593,36031500,36305608,42529123,3013637,40759862,40759756,36304323,42529125,36303431,42529124,42529582,36306115,42528691,3015302,3018576,40759850,3036086,42529584,42529583,42528690,42529598,42529597,42528689,3966634)
  and c.invalid_reason is null
...
WHERE C.value_as_concept_id in (4155142,4183448,45878745,36662448,3427381,3440731,4127785,45884084,9191,4126673,4125547,4123508)
AND (C.value_as_number < C.range_low or C.value_as_number > C.range_high or C.value_as_concept_id in (4155142, 4155143))
-- End Measurement Criteria

) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-120,P.START_DATE) AND A.START_DATE <= DATEADD(day,120,P.START_DATE) ) cc 
